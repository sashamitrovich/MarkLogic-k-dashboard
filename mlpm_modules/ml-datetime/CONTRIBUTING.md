# Contributing to ml-datetime

ml-datetime welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-datetime, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic.
...
* **ml-datetime Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-datetime/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-datetime.git
$ cd ml-datetime
$ git remote add upstream git://github.com/grtjn/ml-datetime.git
```
...
Go to https://github.com/username/ml-datetime and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-datetime/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-datetime/issues
